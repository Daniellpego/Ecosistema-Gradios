...
export function FeatureShowcase() {
  ...
  return (
    <section id="como-funciona" className="bg-white py-16 lg:py-20" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          
          {/* COLUNA ESQUERDA (texto - sticky no desktop) */}
          ...
          {/* COLUNA DIREITA (3 cards de steps empilhados) */}
