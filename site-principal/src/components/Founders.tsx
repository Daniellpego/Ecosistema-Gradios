...
export function Founders() {
  ...
  return (
    <section className="bg-bg-alt py-16 lg:py-20" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center mb-12">
          ...
          <p className="text-text-muted text-lg text-center max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* Founder 1 */}
          <div
            className={`bg-white border border-card-border rounded-card p-8 transition-all duration-700 solution-card ${
          ...
          {/* Founder 2 */}
          <div
            className={`bg-white border border-card-border rounded-card p-8 transition-all duration-700 delay-100 solution-card ${
              inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
          >
            <div className="flex items-center gap-4 mb-6">
        ...
        {/* Badges de parceria */}
        <div className={`flex flex-wrap items-center justify-center gap-4 mt-12 transition-all duration-700 delay-200 ${
          inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
        }`}>
          {["n8n Partner", "Make Certified", "Supabase", "Next.js"].map((badge, i) => (
            <div key={i} className="bg-white border border-card-border rounded-pill px-4 py-2 text-xs font-semibold text-text-muted">
              {badge}
            </div>
          ))}
        </div>
