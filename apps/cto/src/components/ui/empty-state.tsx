...
export function EmptyState({ icon: Icon, title, description, action, className, accentColor = '#00C8F0' }: EmptyStateProps) {
  return (
    <div className={cn('flex flex-col items-center justify-center py-10 sm:py-12 text-center', className)} role="status">
      <div
        className="relative h-14 w-14 rounded-2xl flex items-center justify-center mb-4"
        style={{
