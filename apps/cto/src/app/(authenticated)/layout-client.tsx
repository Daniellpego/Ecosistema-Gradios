  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-bg-navy">
      ...
      <main className="lg:pl-[260px] transition-all duration-300">
        <header className="sticky top-0 z-20 backdrop-blur-xl border-b border-brand-blue-deep/15 px-3 sm:px-6 py-2.5 sm:py-3" style={{ background: 'rgba(10,22,40,0.85)' }}>
          <div className="flex items-center justify-between pl-11 lg:pl-0 gap-2">
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              <div className="h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-status-positive" style={{ boxShadow: '0 0 6px rgba(16,185,129,0.5)' }} />
