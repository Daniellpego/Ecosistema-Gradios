      ...
      <div className="result-cta opacity-0 animate-fade-slide-up" style={{ animationDelay: "0.75s" }}>
        ...
        <div className="relative z-10 text-center">
          <p className="text-white text-xl sm:text-2xl font-bold mb-2" style={{ letterSpacing: "-0.02em" }}>
            {tierInfo.tier === "A" ? "Seu cenário tem urgência real. Vamos resolver isso." :
             tierInfo.tier === "B" ? "Vamos desenhar uma solução juntos?" :
             tierInfo.tier === "C" ? "Pronto para dar o primeiro passo?" :
             "Quer aprender mais antes de começar?"}
          </p>
          <p className="text-[#94A3B8] text-sm max-w-md mx-auto mb-6">
            {tierInfo.tier === "A"
              ? `${lead.nome.split(" ")[0]}, com esse score e urgência, a gente entra em contato hoje. Manda uma mensagem e um especialista da Gradios responde nas próximas horas.`
              : tierInfo.tier === "B"
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            {tierInfo.tier === "D" ? (
              ...
              >
                ...
                Receber guia gratuito por e-mail
              </a>
            ) : (
              <a
              ...
              >
                ...
                {tierInfo.tier === "A" ? "Falar com especialista agora" :
                 tierInfo.tier === "B" ? "Agendar Sessão de Desenho (15 min)" :
                 "Solicitar Sessão de Desenho"}
              </a>
            )}
      ...
      <div className="result-section opacity-0 animate-fade-slide-up mt-8" style={{ animationDelay: "0.8s" }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-[#0F172A] border border-[#1E293B] rounded-2xl p-4">
            ...
            <p className="text-[#94A3B8] text-xs font-semibold">— Diretor Financeiro, Setor de Serviços</p>
          </div>
          <div className="bg-[#0F172A] border border-[#1E293B] rounded-2xl p-4">
            <p className="text-[#CBD5E1] text-sm italic mb-2">&ldquo;A equipe de vendas parou de preencher planilha. O CRM atualiza sozinho com o sistema de gestão.&rdquo;</p>
            <p className="text-[#94A3B8] text-xs font-semibold">— Head Comercial, Distribuidora</p>
          </div>
        </div>
      </div>
